...
This is an early-stage bootstrap phase.
The broader MAP architecture is designed to support more robust, multi-dimensional value flows over time — but those systems are not yet fully in place.
