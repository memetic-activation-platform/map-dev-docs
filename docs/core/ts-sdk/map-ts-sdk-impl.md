...
It is also informed by the descriptor design work under `docs/core/core-runtime/descriptors/`, the runtime shared type foundation under `docs/core/core-runtime/runtime-shared-types.md`, the current query/navigation design under `docs/core/map-queries/`, and the current Dances design under `docs/core/dances/dances-design-spec.md`.
